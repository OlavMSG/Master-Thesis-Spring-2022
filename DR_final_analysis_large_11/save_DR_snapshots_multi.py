...
def save_snapshots(n, mu_grid, mat_grid, root, p_order, power_divider=3):
    ...
    if len(DiskStorage(root)) != mu_grid ** 2:
        d.multiprocessing_save_snapshots(root, mu_grid, material_grid=mat_grid, power_divider=power_divider)
...
def main():
    ...
    save_snapshots(n, mu_grid, mat_grid, root, p_order, power_divider)
    print(datetime.now().time())
