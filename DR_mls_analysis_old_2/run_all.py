...
def main():
    ...
    for p_order in range(1, 25):

        from make_plots_DR_snapshots_for_mls_order_analysis import main as main1
        main1()

        from make_error_plots import main as main_e
        main_e()

        from make_plots_DR_snapshots_for_mls_order_analysis_2 import main as main2
        main2()
